...
# Database: capy
# Generation Time: 2017-04-21 08:02:25 +0000
# ************************************************************
...
CREATE TABLE `doc` (
  ...
  `create_userId` int(10) DEFAULT NULL COMMENT '作者ID',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `projetc_id` int(10) DEFAULT NULL COMMENT '所属项目ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `doc` (`id`, `title`, `content`, `create_userId`, `create_time`, `update_time`, `projetc_id`)
VALUES
	(1,NULL,NULL,NULL,'2017-04-19 17:42:06','2017-04-19 17:42:06',NULL),
	(2,NULL,NULL,NULL,'2017-04-19 17:42:36','2017-04-19 17:42:36',NULL),
	(3,NULL,NULL,NULL,'2017-04-19 17:42:38','2017-04-19 17:42:38',NULL);

/*!40000 ALTER TABLE `doc` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table doc_data_database
# ------------------------------------------------------------

DROP TABLE IF EXISTS `doc_data_database`;

CREATE TABLE `doc_data_database` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '数据库名',
  `version` varchar(20) DEFAULT NULL COMMENT '数据库版本',
  `dec` text COMMENT '数据库描述',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
LOCK TABLES `doc_data_database` WRITE;
/*!40000 ALTER TABLE `doc_data_database` DISABLE KEYS */;

INSERT INTO `doc_data_database` (`id`, `name`, `version`, `dec`, `update_time`, `create_time`, `project_id`)
VALUES
	(2,'capy','v2.1.4','这是毕业设计的数据库','2017-04-19 17:45:58','2017-04-19 17:45:58',2);

/*!40000 ALTER TABLE `doc_data_database` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table doc_data_field
# ------------------------------------------------------------

DROP TABLE IF EXISTS `doc_data_field`;

CREATE TABLE `doc_data_field` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `table_id` int(10) DEFAULT NULL,
  `name` varchar(50) DEFAULT NULL,
  `type` varchar(20) DEFAULT NULL,
  `length` int(4) DEFAULT NULL,
  `primary` int(2) DEFAULT NULL,
  `must` int(2) DEFAULT NULL,
...
# Dump of table doc_data_table
# ------------------------------------------------------------

DROP TABLE IF EXISTS `doc_data_table`;

CREATE TABLE `doc_data_table` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table doc_status_code
# ------------------------------------------------------------

DROP TABLE IF EXISTS `doc_status_code`;

CREATE TABLE `doc_status_code` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table doc_status_code_group
# ------------------------------------------------------------

DROP TABLE IF EXISTS `doc_status_code_group`;

CREATE TABLE `doc_status_code_group` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT NULL COMMENT '状态码分组名',
